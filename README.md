...
Throughout this project, I used ChatGPT to clarify the logic of solving constrained optimization problems and to assist with debugging issues in the code I used for my equations and variable format. 
